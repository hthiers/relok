<div class="flex flex-col">
  ...
  <div class="bg-gray-50 rounded-lg p-4 mb-4 dark:bg-neutral-800">
    <button type="button"
            class="hs-collapse-toggle w-full flex justify-between items-center text-sm font-semibold text-gray-700 dark:text-neutral-300 hover:text-gray-900 dark:hover:text-neutral-200"
        ...
        <div class="border-t border-gray-200 mt-4 pt-4 dark:border-neutral-700">
            <form id="filters">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label for="start_date_filter" class="block text-sm font-medium mb-2 dark:text-white">Fecha Inicio</label>
                      <div class="relative">
              ...
              <table id="grid" class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                  <thead class="bg-gray-50 dark:bg-neutral-800">
                      <tr>
                          ...
                          <th scope="col" class="px-3 py-3 text-start text-xs font-medium text-gray-500 uppercase dark:text-neutral-400" data-sort="unit_name">Departamento</th>
