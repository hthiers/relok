...
<body id="dt_example" class="ex_highlight_row">
    ...
    <div class="row">
        ...
        if($debugMode)
        {
            ...
            print_r($id_profile); print('<br />');
            print_r($id_task); print('<br />');
            print_r($label_type); print('<br />');
            ...
            print("server date: ".date("Y/m/d"));print('<br/>');
            print("server time: ".date("H:i:s"));print('<br/>');
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="medium-3 columns">
                  <label for="resp" class="text-right middle">Responsabless</label>
                </div>
              ...
              <?php if($id_user == $session->id_user || $session->id_profile == 1 || $session->id_profile == 3): ?>
