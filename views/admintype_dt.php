...
<?php require_once('js_admtypes_dt.php'); # JS ?>
...
//            print_r($arrayDates);print('<br />');
        ...
        <?php require('modal_types_dt.php'); //Opciones para borrar?>
        ...
        <!-- DATATABLE -->
        <div id="dynamic">
            <form id="dt_form" method="POST" action="<?php echo "?controller=admtypes&amp;action=ajaxTypesDt";?>">
