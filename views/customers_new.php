          ...
          <form id="moduleForm" name="form1" method="post"  action="?controller=customers&amp;action=customersAdd">
            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="row">
                    <div class="medium-3 columns">
                        <label for="customer_dni" class="text-right middle">RUN Cliente (Sin puntos, sólo con guión)</label>
                    </div>
                    <div class="medium-9 columns">
                        <input class="input_box" name="customer_dni" type="text" id="customer_dni" value="" />
                    </div>
                </div>
