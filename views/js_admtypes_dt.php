...
$(document).ready(function() {
    ...
    oTable = $('#table').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": <?php echo "'?controller=admtypes&action=ajaxTypesDt'";?>,
        ...
        "fnDrawCallback": function () {
            $('#table tbody td.td_editable').editable( '?controller=admtypes&action=ajaxTypesUpdate', {
    ...
    $('#confirmarEliminarMateria').click(function() {
        ...
        var urlAction = "<?php echo "?controller=admtypes&action=typesRemove";?>";
