...
<body>
    ...
    <div class="row login">
      ...
      <div class="medium-6 medium-centered large-4 large-centered columns">
        <!-- <h2 class="text-center pushed-up title">
          <a href="<?php echo $_SERVER['PHP_SELF'];?>">Relok</a>
        </h2> -->
        <a style="display: block; margin-top: 80px;" href="<?php echo $_SERVER['PHP_SELF'];?>">
          <img src="views/img/relok_logo.png" alt="Relok"/>
        </a>
      </div>
      ...
      ?>
        ...
        <?php if(isset($userSession) && $userSession == 1){
            echo "<div id='errorbox_failure' class='callout warning' data-closable>\n";
