...
class TypesModel extends ModelBase
{
	...
	*******************************************************************************/
	...
	public function getTypesByCustomer($id_tenant, $id_customer)
	{
         ...
         * @return PDO
         */
        public function getTypeByID($id_tenant, $id_management)
        {
            $consulta = $this->db->prepare("
				SELECT id_type
                                    , code_type
         ...
         * @return pdo
         */
        public function addNewType($id_management, $code_type, $id_tenant, $label_type)
	{
         ...
         * @return pdo
         */
        public function addNewTypeWithCustomer($id_management, $code_type, $id_tenant, $label_type, $id_customer)
	{
            $this->db->exec("set names utf8");
	...
	public function getMyLastType($id_tenant, $id_user)
{
			...
			FROM
				cas_task a
			INNER JOIN (select max(x.date_ini) AS date_ini from cas_task x
         ...
         * @return pdo
         */
        public function updateFieldType($id_management, $code_type, $id_tenant, $label_type)
	{
            $this->db->exec("set names utf8");
         ...
         * @return pdo
         */
        public function updateType($id_management, $code_type, $id_tenant, $label_type)
	{
            $this->db->exec("set names utf8");
        ...
        public function updateTypeDinamic($id_types, $column, $value)
    {
         ...
         * @return PDO
         */
        public function updateStatusType($id_management, $id_tenant, $status_type)
	{
            $this->db->exec("set names utf8");
	...
	public function getTypesByUsersTenant($id_tenant){
		$consulta = $this->db->prepare("
			SELECT
				a.id_type
			FROM
	...
	public function getTypesByAllUsers($id_tenant){
		$consulta = $this->db->prepare("
			SELECT
				a.id_user
				, b.id_type
        ...
        public function updateAdminManagment($id_management, $column, $value)
    {
         $this->db->exec("set names utf8");
    ...
    public function getManagementByID($id_tenant, $id_management)
        ...
        public function updateManagement($id_management, $code_management, $id_tenant, $label_management)
	{
            $this->db->exec("set names utf8");
            ...
            $consulta2 = $this->db->prepare("UPDATE cas_task
            SET
            label_task = '$label_management'
            WHERE id_tenant = $id_tenant
              AND id_management = $id_management");              
