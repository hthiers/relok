...
class AdminController extends ControllerBase
{
    ...
    *******************************************************************************/
    ...
    {
        // Usamos inyección de dependencias en lugar de require_once
        $this->model = new AdminModel();
        $this->errorMessage = new ErrorMessage(); // Inicializa el objeto ErrorMessage
        $this->view = new View();
    }
    ...
    {
        error_log("In the privilegiosPanel controller method");
        //Titulo pagina
